"""
PROTOTYPE — inline SVG for the contact row.

Inline rather than an icon font: these are 24x24 paths using `currentColor`, so
they inherit the palette and scale with the text-size setting without a second
loading path. GitHub and LinkedIn are the official brand marks, used to link to
those services. Email and resume are generic glyphs — an envelope and a document.
"""
...
_PATHS = {
    "github": (
        ...
        "3.285-1.23.645 1.653.24 2.873.12 3.176.765.841 1.23 1.911 1.23 3.221 0 4.609-2.805 "
        "5.625-5.475 5.921.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 "
    ...
    "email": (
        ...
        "4.25-8 4.75-8-4.75V6l8 4.75L20 6v2.25z"
    ),
    # Document with a folded corner — the resume.
    "resume": (
        "M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 "
