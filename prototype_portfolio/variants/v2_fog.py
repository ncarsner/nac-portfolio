...
The far end of 'lighter' while still being dark. The ground comes up to a mid
slate and the text contrast comes down to match, so the page reads soft and even
rather than punchy. If Slate still feels heavy, this is the next stop.
...
NAME = "Fog — mid slate, low contrast"

CSS = """
<style>
:root { --bg:#2b323b; --pan:#272e36; --r:#454e5a; --r2:#39414b;
        --fg:#e8ecf1; --fg2:#c2cad3; --m:#94a0ad; --m2:#7f8b98;
        --a:#8cc6ff; --ok:#6cc26c; --hv:#333b45; --sel:#33404f; --selb:#465871;
        --code:#242a32; }
...
def render():
    ...
    shell.stage(a, placeholder_tint="#3a5372", tone="fog")
